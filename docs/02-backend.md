...
- **Atualização de status de tarefa (`PATCH /tasks/:id`)**: mesma proteção contra IDOR das demais rotas de Tarefas — confere que a tarefa pertence a um projeto da empresa do usuário antes de atualizar.
